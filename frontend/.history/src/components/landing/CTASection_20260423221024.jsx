...
export default function CTASection() {
  ...
  return (
    <section style={{ backgroundColor: "#fff", padding: "6rem 1.5rem" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.25rem" }} className="cta-cards">
        ...
        <CTACard
          ...
          desc="List properties, manage clients and grow your real estate business on Rwanda's leading platform."
          cta="Register as Agent"
          onClick={() => navigate(ROUTES.REGISTER)}
          ctaStyle={{ backgroundColor: "var(--color-primary)", color: "#fff" }}
        />
      </div>
