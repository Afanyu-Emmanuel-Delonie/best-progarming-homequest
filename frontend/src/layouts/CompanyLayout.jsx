  ...
  return (
    <div style={{ display: "flex", height: "100vh", overflow: "hidden", backgroundColor: "var(--color-bg-muted)" }}>
      ...
      <div style={{
        ...
        <Sidebar collapsed={!isMobile && collapsed} nav={COMPANY_NAV} />
      </div>
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        <Header fullName="Company Admin" role="ROLE_COMPANY_ADMIN" onToggleSidebar={toggle} profileHref="/company/settings" settingsHref="/company/settings" />
